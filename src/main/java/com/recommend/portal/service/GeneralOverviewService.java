...
public interface GeneralOverviewService {
    ...
    List<GeneralOverview> getAllGroupTopics(String group, Long iSortingCode);
    List<GeneralOverview> getAllUseReview(String username, Long iSortingCode);
    List<GeneralOverview> getAllGroupTopicsForHome(Long iSortingCode);
