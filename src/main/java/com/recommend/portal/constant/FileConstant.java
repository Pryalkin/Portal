...
public class FileConstant {
    ...
    public static final String USER_FOLDER = System.getProperty("user.home") + "/recommendation/portal/user/";
...
//    public static final String DEFAULT_OVERVIEW_IMAGE_PATH = "/user/image/overview";
